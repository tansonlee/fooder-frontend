...
import { Text, Image, View, TouchableWithoutFeedback, Button } from "react-native";
		...
		>
			<TouchableWithoutFeedback>
				<View>
					...
					<Text>View on Yelp: {props.url}</Text>
					<Button title="Left" onPress={onSwipeLeft} />
					<Button title="Right" onPress={onSwipeRight} />
				</View>
			</TouchableWithoutFeedback>
		</GestureRecognizer>
	);
